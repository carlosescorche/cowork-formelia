# Partners (consultores y agencias multiplicadores)

El consultor multiplicador es la persona secundaria del beachhead: monta formularios para SUS
clientes (10–30 forms activos cada uno) y es distribución encubierta vía el badge. El programa
...
3. **Convertir en campeones:** caso de estudio con su marca, mención en redes, acceso temprano
   a features (p. ej. API v0 en Q4).

## Señales de éxito

≥15 agencias partner activas para H1-2027 (criterio de salida de fase). Cada partner activo
mueve el FAS más que 10 usuarios sueltos.
